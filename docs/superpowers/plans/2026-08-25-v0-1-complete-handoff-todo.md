...
- [ ] Run `uv run --extra dev pytest -q`; the current baseline expectation is 402 passing tests.
...
### M3.1 Write and approve the exact shared/type plans
...
### M4.2 Persisted run, target, lease, and report contracts
